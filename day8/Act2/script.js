...
// name, capital, populations and languages.

names = Object.values(countries);
for (let i = 0; i <= names.length; i++) {
  console.log(names[i].name);
}
names = Object.values(countries);
for (let i = 0; i <= names.length; i++) {
  console.log(names[i].capital);
}
names = Object.values(countries);
for (let i = 0; i <= names.length; i++) {
  console.log(names[i].population);
}
names = Object.values(countries);
for (let i = 0; i <= names.length; i++) {
  console.log(names[i].languages);
}
