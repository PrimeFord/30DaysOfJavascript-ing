...
//   console.log(
//     (countrie.name = name),
//     (countrie.capital = capital),
//     (countrie.population = population),
//     (countrie.languages = languages)
//   );
// }

//2.A junior developer structure student name, skills and score in array of arrays which may not easy to read. Destructure the following array name to name, skills array to skills, scores array to scores, JavaScript score to jsScore and React score to reactScore variable in one line.
const studentt = ["David", ["HTM", "CSS", "JS", "React"], [98, 85, 90, 95]];
let [name, skills, ...rest] = studentt;
const scores = rest.flat();
...
console.log((student.skills.frontEnd.skill = "Bootstrap"));
console.log((student.skills.frontEnd.level = 8));

//ii. Add Express with level 9 to the back end skill sets
console.log((student.skills.backEnd.skill = "Express"));
console.log((student.skills.backEnd.level = 9));

//iii. Add SQL with level 8 to the data base skill sets
console.log((student.skills.dataBase.skill = "Express"));
console.log((student.skills.dataBase.level = 9));

//iv. Add SQL without level to the data science skill sets
console.log((student.skills.dataScience.skill = "Express"));
console.log((student.skills.dataScience.level = 9));
