...
const searchNo = document.querySelector(".searchno");
...
const arr1 = document.querySelector(".arrowup");

const arr2 = document.querySelector(".arrowdown");

// const eachCountry = document.querySelector(".each");
...
// //inputs
total.textContent = `Total Numbers of countries: ${countries_data.length}`;

let countries = [];
countries_data.map((country) =>
  countries.push(country.name.toLocaleUpperCase())
);
